...
| Модель | Fast Mode |
| Дата | 2026-05-20 (UTC) |
| Закрытые задачи | E-012, E-013, E-014, E-015, E-016 |
| Следующая задача | E-017 -- интеграция Temple в лобби и паспорт |
...
### 2026-05-20 · PBerty · E-016
- Закрыто: E-016 -- matrix.html v2.0: кнопка постройки храма.
- Блок Храма с статистикой, кнопка постройки/управления, церемониальный попап.
- Следующая задача: E-017 -- интеграция Temple в лобби и паспорт.
