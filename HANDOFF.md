...
| Модель | Fast Mode |
| Дата | 2026-05-20 (UTC) |
| Закрытые задачи | E-012, E-013, E-014, E-015, E-016, E-017 |
| Следующая задача | E-018 (следующий блок) |
...
### 2026-05-20 · PBerty · E-017
- Закрыто: E-017 -- интеграция Temple в лобби и паспорт.
- Виджет "ХРАМ" в index.html (статус/свет/уровни).
- Секция храма в passport.html (карточка с статистикой).
- Блок Temple v2.0 (E-012..E-017) полностью завершён.
