...
### Маркеры храмов на карте

- [x] **T-083 · earth-player.html — маркеры храмов на Canvas**
  DoD: кольцо из 33 маркеров вокруг Васту-сетки. Построенные храмы — золото со свечением, непостроенные — тусклые. Hover-тултип с именем храма, вселенной и статусом. Счётчик N/33. Данные из `data/temple-ecosystems.json` + `localStorage awara_temples_v258`.
  Файлы: `earth-player.html`
  Est: 10 мин
